...
class Utils {
    ...
    static void getHoleClouds(pcl::PointCloud<pcl::PointXYZ>::Ptr interior_boundaries,
    ...
    static void calcHoleCenters(std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> &holes,
